...
try {
    ...
    if(!localStorage.getItem('products')) {
        ...
        let product4 = new Product('product4', 'description4', 400, 0, 2, false, 'image4', new Date(), new Date());
        let product5 = new Product('product5', 'description5', 500, 50, 1, true, 'image5', new Date(), new Date());
        let product6 = new Product('product6', 'description6', 600, 60, 5, true, 'image6', new Date(), new Date());
    ...
    array.forEach((product:Product) => {
        content += `
            <div class="product">
                ...
                <div>
                <img src="${product._image}" alt="${product._title}">
                <ul>
